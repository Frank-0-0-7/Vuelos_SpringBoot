...
-- 4. INSERTAR PERSONA Y PILOTO DE PRUEBA
...
-- 6. INSERTAR ASIENTOS MAESTROS (1 disponible por avión)
INSERT INTO asientos (id_asiento, numero_avion, fila_asiento, letra_asiento, clase_asiento) VALUES (1, 101, 1, 'A', 'BUSINESS');
INSERT INTO asientos (id_asiento, numero_avion, fila_asiento, letra_asiento, clase_asiento) VALUES (2, 102, 5, 'B', 'TURISTA');
INSERT INTO asientos (id_asiento, numero_avion, fila_asiento, letra_asiento, clase_asiento) VALUES (3, 103, 3, 'C', 'ECONOMY');
INSERT INTO asientos (id_asiento, numero_avion, fila_asiento, letra_asiento, clase_asiento) VALUES (4, 104, 12, 'D', 'TURISTA');
INSERT INTO asientos (id_asiento, numero_avion, fila_asiento, letra_asiento, clase_asiento) VALUES (5, 105, 2, 'F', 'BUSINESS');
...
-- 9. INSERTAR USUARIO INICIAL POR DEFECTO
INSERT INTO personas (dni_persona, nombre_persona, apellido_persona) VALUES (38111222, 'Juan', 'Perez');
INSERT INTO usuarios (dni_persona, numero_usuario, contrasenia_usuario, correo_electronico_usuario) VALUES (38111222, 10, 'admin123', 'juan@mail.com');